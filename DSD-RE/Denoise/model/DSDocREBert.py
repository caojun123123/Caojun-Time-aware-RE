...
class DSDocREBert(nn.Module):
    ...
    def forward(self, data, config, gpu_list, acc_result, mode):
        ...
        output1 = self.bert(data['doc1'], encoder_attention_mask = data['attMask1'])
        hidden1 = output1.last_hidden_state
        output2 = self.bert(data['doc2'], encoder_attention_mask = data['attMask2'])
        hidden2 = output2.last_hidden_state
